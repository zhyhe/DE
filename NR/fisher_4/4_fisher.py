import bilby
import logging
from numpy import sqrt, zeros, pi, log, exp
...
def fisher_matrix_for_single_ifo(ifo, fiducial_dict, step_dict):
    ...
    def hf(parameters):
        ...
        params_wf_gen = dict(
            ...
            ra                  = parameters['ra'], 
            dec                 = parameters['dec'], 
            luminosity_distance = exp(parameters['lnd_L']), 
    ...
    params_d_lnd_L      = copy.deepcopy(fiducial_dict)
    ...
    params_d_lnd_L['lnd_L']           += step_dict['lnd_L']
    ...
    dh_lst = [ (hf_d_total_mass - hf_fidu)/step_dict['total_mass'],
            ...
            #    (hf_d_iota       - hf_fidu)/step_dict['iota'],
               ...
               (hf_d_lnd_L      - hf_fidu)/step_dict['lnd_L']
            ]
    num_para = len(dh_lst)
...
print(sqrt(cov_m[5,5]+(0.05*z)**2))
#print(sqrt(cov_m[6,6]))
